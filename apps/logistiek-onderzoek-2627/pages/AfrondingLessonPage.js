 ...
 * AfrondingLessonPage
 *
 * Afronding (afronding.html): onderzoeksplan afronden
 */

// Export will be set immediately after class definition
class AfrondingLessonPage extends BaseLessonPage {
    constructor() {
        super('afronding', 'Afronding', 'Onderzoeksplan afronden');
    ...
    renderContentSections() {
        ...
        if (this.content.leerdoelen.interactive && this.content.leerdoelen.items && this.content.leerdoelen.items.length > 0) {
            ...
            leerdoelenContent = ContentRenderer.renderLearningObjectivesChecklist({
                ...
                storageKey: 'afronding-learning-objectives'
            });
        } else {
            // Use standard list
            leerdoelenContent = `
...
(function() {
    try {
        if (typeof module !== 'undefined' && module.exports) {
            module.exports = AfrondingLessonPage;
        } else {
            window.AfrondingLessonPage = AfrondingLessonPage;
        }
    } catch (error) {
        console.error('[AfrondingLessonPage] Error exporting:', error);
        try {
            window.AfrondingLessonPage = AfrondingLessonPage;
        } catch (e) {
            console.error('[AfrondingLessonPage] Failed to force export:', e);
        }
    }
})();
