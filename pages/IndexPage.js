 ...
 * IndexPage
 * 
 * Specifieke pagina voor de index/start pagina
 * Gebruikt de statische content uit index.html in plaats van template content
 */

class IndexPage extends BaseLessonPage {
    constructor() {
        super('start', 'Start', 'Opzetten van Logistieke Onderzoeken');
    }

    /**
     * Render module introductie - overschrijf met statische content
     */
    renderModuleIntro() {
        return `
    ...
    /**
     * Render hoofdcontent gebied - overschrijf om juiste spacing te behouden
     */
    renderMainContent() {
        return `
    ...
    /**
     * Render content secties - overschrijf met statische content uit index.html
     */
    ...
    /**
     * Attach event listeners - overschrijf om PDF export button te koppelen
     */
    attachEventListeners() {
        // Roep eerst de parent methode aan
...
console.log('IndexPage.js executed');
...
console.log('IndexPage assigned to window.IndexPage', window.IndexPage);
